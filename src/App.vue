    ...
    <div>
      <b-navbar toggleable="lg" variant="dark-blue" type="dark">
        <b-navbar-brand :href="this.$store.state.urls.navbarBrandUrl">
          ...
          <div class="verticalLine d-inline-flex align-top pl-2" v-if="userIsStaff"></div>
          <div id="name-large" class="name text-left pl-2 align-top d-none d-lg-inline-block" v-if="userIsStaff">Data<br />Inspector</div>
          <div id="name-small" class="name text-left pl-2 align-top d-inline-block d-lg-none" v-if="userIsStaff">Data<br />Inspector</div>
        </b-navbar-brand>
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            ...
            <b-nav-item :href="this.$store.state.urls.networkMonitoringPortalUrl" v-if="userIsStaff">Network Monitoring Portal</b-nav-item>
            <b-nav-item :href="this.$store.state.urls.roguesGalleryUrl" v-if="userIsStaff">Rogue's Gallery</b-nav-item>
